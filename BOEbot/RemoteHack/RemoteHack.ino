...
void setup() {
  ...
  pinMode(pinLB, INPUT);
  digitalWrite(pinLB, HIGH); // pulldown current unless signal recieved from R/C unit
  pinMode(pinLF, INPUT);
  digitalWrite(pinLF, HIGH); // pulldown current unless signal recieved from R/C unit
  pinMode(pinRB, INPUT);
  digitalWrite(pinRB, HIGH); // pulldown current unless signal recieved from R/C unit
  pinMode(pinRF, INPUT);
  digitalWrite(pinRF, HIGH); // pulldown current unless signal recieved from R/C unit
