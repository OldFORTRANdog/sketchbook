...
void loop()                                  // Main loop auto-repeats
{
  ...
  for(int pulseWidth = 1300; pulseWidth <= 1700; pulseWidth += 25)
  {
    ...
    servoLeft.writeMicroseconds(pulseWidth); // Pin 11 servo speed = pulse
    delay(6000);                             // ..for 6 seconds
    servoLeft.writeMicroseconds(1500);       // Pin 11 servo speed = stop
  }
}
