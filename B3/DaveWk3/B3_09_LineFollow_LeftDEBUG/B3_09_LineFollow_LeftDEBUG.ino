...
// IO Pins used
const byte LEFT_BUMP_PIN = 45;    // Define DIGITAL Pins for left
const byte RIGHT_BUMP_PIN = 44;   // and right bump sensors
...
void setup(void) {
  ...
  */
  while (digitalRead(RIGHT_BUMP_PIN) == HIGH) {
    Serial.println("Waiting for Right bumper.");
  } // Pause until the pin is grounded (our switch)
  delay(50);
