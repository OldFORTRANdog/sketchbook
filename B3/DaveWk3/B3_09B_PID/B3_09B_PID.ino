   ...
   forward, following a black line.
   
   Based on B3_09_LineFollowLeft.ino for GSSM/GoSciTech 2015, Week 3
   
   First try at a PID, actually just the P part initially
   
   Stop at a specified distance from an object directly ahead.
   Arduino: Arduino Mega 256 v3 Clone
   Motor Shield: Adafruit assembled Motor Shield for Arduino v2
   ---->  http://www.adafruit.com/products/1438
   Programmer: Dave Eslinger; 7/9/2015
   Revisions:  
*/
#include <Wire.h>
